...
Функция ПолучитьДанныеСайта()
	...
	КомандаЗапроса.ДобавитьПараметр(СтрШаблон(" -c %1 -s -L %2", ФайлПеченек, ПараметрыПриложения.СервисРелизов()));
...
Функция ПолучитьСписокКонфигураций()
	...
	КомандаЗапроса.ДобавитьПараметр(СтрШаблон("%1%2""", "https://releases.1c.eu", "/total"));
