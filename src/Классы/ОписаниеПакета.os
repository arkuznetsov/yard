...
Перем мСвойстваПакета;      // - Структура          - свойства пакета
Перем мЗависимости;         // - ТаблицаЗначений    - описания зависимостей пакета
Перем мМодули;              // - ТаблицаЗначений    - описания модулей пакета
Перем мВключаемыеФайлы;     // - Массив             - включаемые в пакет файлы
Перем мИсполняемыеФайлы;    // - ТаблицаЗначений    - описания исполняемых файлов пакета
