...
Процедура УстановитьПараметрыОбработчика(Знач ОписаниеОбработчика)
	...
	Если ОписаниеОбработчика.Свойство("Параметры") Тогда
		...
		Для Каждого ТекПараметр Из ОписаниеОбработчика.Параметры Цикл
			...
			Лог.Отладка("[%1]: Установка параметра обработчика ""%2 / %3"": ""%4""",
			            ТипЗнч(ЭтотОбъект),
			            ОписаниеОбработчика.ИмяОбработки,
			            ТекПараметр.Ключ,
			...
			Лог.Отладка("[%1]: Вычислено значение параметра обработчика ""%2 / %3"": ""%4""",
						ТипЗнч(ЭтотОбъект),
						ОписаниеОбработчика.ИмяОбработки,
						ТекПараметр.Ключ,
...
//  ДопустимыеТипы       - Строка, Массив из Строка, Тип  - список допустимых типов
