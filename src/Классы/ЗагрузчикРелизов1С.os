...
Процедура ОписаниеКоманды(Команда) Экспорт
	...
	Команда.Опция("dn download-newinfo", Ложь, "скачивать ""Новое в версии""")
	       .Флаг();	   
...
Процедура ВыполнитьКоманду(Знач Команда) Экспорт
	...
	УстановитьПараметрОбработкиДанных("СкачиватьНовоеВВерсии"         , Команда.ЗначениеОпции("download-newinfo"));
