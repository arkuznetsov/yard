	...
	Для Каждого ТекЭлемент Из НакопленныеДанные Цикл
		...
		Для Каждого ТекВерсия Из ВерсииПриложения Цикл
			...
			Для Каждого ТекСсылка Из СписокСсылок Цикл
				...
				ЗаписатьОписаниеВерсииВФайл(ТекЭлемент.Идентификатор,
				                            ТекЭлемент.Имя,
				                            ТекЭлемент.Версия,
				                            ТекЭлемент.Дата,
				                            ВидДистрибутива,
				...
				Если ТекВерсия.ЭтоКонфигурация И РаспаковыватьEFD Тогда
					Лог.Информация("Начало распаковки архива EFD ""%1"" конфигурации ""%2"", версия ""%3""-%4 в каталог ""%5"".",
					...
					КаталогДляРаспаковки = ОбъединитьПути(КаталогДляРаспаковкиEFD, ТекЭлемент.Идентификатор, ТекВерсия.Версия);
...
Процедура ЗаписатьОписаниеВерсииВФайл(Идентификатор, Имя, Версия, ДатаВерсии, ВидДистрибутива, Путь)

	Описание = Новый Структура("Идентификатор, Имя, Версия, Дата, ВидДистрибутива");
	Описание.Идентификатор   = Идентификатор;
	Описание.Имя             = Имя;
	Описание.Версия          = Версия;
	Описание.Дата            = ДатаВерсии;
	Описание.ВидДистрибутива = ВидДистрибутива;
