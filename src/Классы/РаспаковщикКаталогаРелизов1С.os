...
Процедура УстановитьПараметрОбработкиДанных(Знач ИмяПараметра, Знач Значение) Экспорт
	...
	Если ВРег(ИмяПараметра) = ВРег("ФайлыДляРаспаковкиEFD") Тогда
		Если ТипЗнч(Значение) = Тип("Массив") Тогда
			ФайлыДляРаспаковкиEFD = Значение;
		Иначе
			ФайлыДляРаспаковкиEFD = СтрРазделить(Значение, "|");
		КонецЕсли;
	ИначеЕсли ВРег(ИмяПараметра) = ВРег("ПутьККаталогуДистрибутивов") Тогда
		ВремФайл = Новый Файл(Значение);
		ПутьККаталогуДистрибутивов = ВремФайл.ПолноеИмя;
	ИначеЕсли ВРег(ИмяПараметра) = ВРег("КаталогДляРаспаковкиШаблонов") Тогда
		ВремФайл = Новый Файл(Значение);
