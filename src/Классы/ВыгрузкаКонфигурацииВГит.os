...
Процедура УстановитьПараметрыОбработкиДанных(Знач НовыеПараметры) Экспорт
	...
	ПутьККонфигурации = "";
	Если ПараметрыОбработки.Свойство("ПутьККонфигурации") Тогда
		ПутьККонфигурации = ПараметрыОбработки.ПутьККонфигурации;
	КонецЕсли;
	...
	ИмяВеткиГит = "base1c";
	Если ПараметрыОбработки.Свойство("ИмяВеткиГит") Тогда
		ИмяВеткиГит = ПараметрыОбработки.ИмяВеткиГит;
	КонецЕсли;
	...
	ДатаКоммита = ДатаPOSIX(ТекущаяУниверсальнаяДата());
	Если ПараметрыОбработки.Свойство("ДатаКоммита") Тогда
		ДатаКоммита = ПараметрыОбработки.ДатаКоммита;
	КонецЕсли;

	СообщениеКоммита = "";
	Если ПараметрыОбработки.Свойство("СообщениеКоммита") Тогда
		СообщениеКоммита = ПараметрыОбработки.СообщениеКоммита;
	КонецЕсли;
...
Процедура УстановитьПараметрОбработкиДанных(Знач ИмяПараметра, Знач Значение) Экспорт
	...
	Если ВРег(ИмяПараметра) = ВРег("ПутьККонфигурации") Тогда
		ПутьККонфигурации = Значение;
	ИначеЕсли ВРег(ИмяПараметра) = ВРег("РепозитарийГит") Тогда
		РепозитарийГит = Значение;
	ИначеЕсли ВРег(ИмяПараметра) = ВРег("ИмяВеткиГит") Тогда
		ИмяВеткиГит = Значение;
	ИначеЕсли ВРег(ИмяПараметра) = ВРег("ИмяАвтора") Тогда
		ИмяАвтора = Значение;
	ИначеЕсли ВРег(ИмяПараметра) = ВРег("ПочтаАвтора") Тогда
		ПочтаАвтора = Значение;
	ИначеЕсли ВРег(ИмяПараметра) = ВРег("ДатаКоммита") Тогда
		ДатаКоммита = Значение;
	ИначеЕсли ВРег(ИмяПараметра) = ВРег("СообщениеКоммита") Тогда
		СообщениеКоммита = Значение;
...
Процедура ОписаниеКоманды(Команда) Экспорт
	...
	Команда.Опция("d git-commit-date", ДатаPOSIX(ТекущаяУниверсальнаяДата()), "дата коммита в git в формате POSIX")
	       .ТСтрока()
