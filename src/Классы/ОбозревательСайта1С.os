...
Функция ПолучитьСписокПриложений(Знач Фильтр = Неопределено,
	...
	// Сообщить("ТекстСтрокиКонфигурации: " + ТекстСтрокиКонфигурации);
	// Сообщить("ШаблонПоискаКонфигураций: " + ПараметрыПриложения.ШаблонПоискаКонфигураций());
	// Сообщить("НайденныеОписания: " + НайденныеОписания.Количество());
