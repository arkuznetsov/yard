...
Процедура ОбработатьДанные() Экспорт
	...
	Для Каждого ТекОписание Из ВерсииДляОбработки Цикл
		...
		СообщениеКоммита = СтрШаблон("Обновление версии конфигурации поставщика на %1", ТекОписание.Версия) + Символы.ПС;
		СообщениеКоммита = СообщениеКоммита + Символы.ПС;
		СообщениеКоммита = СообщениеКоммита + "Страница релиза:" + Символы.ПС;
		СообщениеКоммита = СообщениеКоммита + "https://releases.1c.ru/" + ТекОписание.Путь + Символы.ПС;
		ВерсииДляОбновления = СтрСоединить(ТекОписание.ВерсииДляОбновления, ", ");
		СообщениеКоммита = СообщениеКоммита + "Версии для обновления: " + ВерсииДляОбновления;
